...
\resp{We explored the planning times for queries with increasing number of joins. The standard algorithm presented in the original version submitted handles
