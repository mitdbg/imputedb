...
\resp{To clarify, we've removed the predicate condition $schooldegree \geq 0$, this was actually a trivial satisfied predicate, given the way
  our dataset was set up. 
  \todo{still need to address the point on data skew}
}
