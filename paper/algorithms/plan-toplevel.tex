...
\begin{algorithmic}[1]
  ...
  \State $Q[\{t\}] \lhd \{\sigma_{\phi}(q)\ |\ q \in \Call{Impute}{t, \Call{Attr}{\phi}, C_g}\}$~\label{lst:line:sel}
  ...
  \State $L \gets \{\Call{Impute}{q,\ \Call{Attr}{\psi},\ C_g} ~|~ q \in Q[S \setminus t] \}$
  \State $R \gets \{\Call{Impute}{q,\ \Call{Attr}{\psi},\ C_g} ~|~ q \in Q[\{t\}] \}$
  ...
  \State $C_l \gets G \cup \Call{Attr}{A}$
