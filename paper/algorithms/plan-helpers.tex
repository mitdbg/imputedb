%\begin{algorithm}
  \begin{algorithmic}
    ...
    \Require{$q$ is a query plan, $G$ is a set of grouping attributes, $A$ is an aggregation function, and $C_g$ is a set of visible attributes.}
    ...
    \State $L \gets \{\Call{AddImpute}{q, C, C_g} ~|~ q \in Q[t] \}$
    \State $R \gets \{\Call{AddImpute}{q, C, C_g} ~|~ q \in Q[S'] \}$
