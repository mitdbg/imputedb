...
of probabilistic compositional repair operators called \textit{Lenses}. These can be used
to repair missing values by imposing data constraints such as \texttt{NOT NULL}. 
As with \ProjectName{}, they provide a way to balance the quality of the cleaning 
