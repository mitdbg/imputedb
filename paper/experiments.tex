...
After a warm-up period, each query ran for 200 iterations \todo{iterations? is this for the imputation or is it the number of query re-runs?} in both settings and then results from the two approaches were paired up and compared tuple-wise.
