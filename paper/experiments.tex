...
\begin{table}
  \centerfloat
  \input{runtimes}
    \caption{Base error, change in error and and running time for queries
...
This time compares favorably to our maximum of 55 seconds for a query with imputation on the ACS data.
