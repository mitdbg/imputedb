...
The Count columns in \Cref{table:smape} show the percentage difference between the number of tuples in the aggregate for $\alpha = 1$ and $\alpha = 0$ and running the query on the imputed base table.
...
In these cases, the aggregate value is not significantly impacted by the missing data.
