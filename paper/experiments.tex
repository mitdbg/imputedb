...
\caption{Query runtimes with imputation on base tables, \ProjectName{}
    ...
    relatively expensive queries over large datasets (Query 9), runtime of imputation can be reduced from \acsbaseresulthours~to \acsimputedbzeroresult. \srm{make this a bar graph}}
