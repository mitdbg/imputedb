...
\begin{figure}
\includegraphics[width=\columnwidth]{figures/pareto_frontiers_plot.png}
...
there may be small clusters of plans centered around a similar penalty or time value. The frontier is produced before executing a plan and can be exposed
to the user.}
