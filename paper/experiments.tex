...
%\label{fig:plantimes}
%\end{figure}
\subsubsection{Accuracy vs. Base-table Imputation}\label{subsec:accuracy}
...
deck imputation (\Cref{sec:imputation}). In our implementation of mean-value imputation,
to facilitate non-blocking operation within the iterator
model, we estimate the column mean from base table histograms. Therefore,
