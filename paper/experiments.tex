...
Queries 1-4 are on the CDC data. In Query~\ref{q1}, we calculate the average height for
...
Queries 5-8 are on the FCC data. In Query~\ref{q6}, we calculate the average income for
