...
In general, the SMAPE relative to the base-imputation approach are low in all cases --- between \lowsmapealphazero{} and \highsmapealphaoneexacs{} percent ---, indicating that on-the-fly imputation produces
