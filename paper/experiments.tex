...
Planning times (~\Cref{fig:planning-times}) for queries involving 1--5 joins---a practical value for a practical subset of real world exploratory queries---are less than 1 second.
