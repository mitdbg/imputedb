...
\begin{table}
  ...
  \input{runtimes}
    ...
    data and the query run on dirty data without imputation. \todo{Micah: Not clear to me
...
Planning times are not shown\todo{they are shown...}, as they are fractions of a second for all of the queries that we tested.
...
\todo{consider giving up on getting the references to work?}
\begin{itemize}
