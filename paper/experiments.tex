...
queries are an \todo{update/validate: order-of-magnitude faster than imputing on the base tables. We can get
...
\todo{update: In the median across a variety of queries and choices of $\alpha$, planning took
