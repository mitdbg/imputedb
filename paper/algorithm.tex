...
(\Cref{sec:cost-model}) which describe the new algorithm.
An imputation strategy is a function $I(T, C) \rightarrow T'$ which fills in the missing attributes $C$ in a set of tuples $T$, returning a new set of tuples $T'$.
