...
account for the new operators: \textit{Drop} and \textit{Impute}. \textit{Drop} is a special
case of a selection, and as a non-blocking operator its effective time cost is negligible.  
