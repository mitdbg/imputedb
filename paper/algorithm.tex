...
Algorithm{~\ref{algo:top-level-planner} plans the query in stages. It first handles any pushed-down selections, it then optimizes joins, then groupby/aggregations,
