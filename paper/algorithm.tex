...
The space of query plans is similar to that considered by System R~\cite{blasgen1981system}, with the addition of imputation operators appearing before/after traditional operators.
Figure \ref{fig:query-schematic} shows a simple schematic of what a query involving three tables might look like, absent any imputation operators.


\begin{figure}
\Tree [.$\pi$ [.$GroupBy$ [.$\bowtie$ [.$\bowtie$ [.$\sigma$ $t_1$ ] [.$\sigma$ $t_2$ ] ] [.$\sigma$ $t_3$ ] ] ] ]
