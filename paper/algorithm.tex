...
\ProjectName{} estimates the aggregate quality of the imputations in a plan $q$ using the heuristic measure $\textsc{Penalty}_{P}(q)$, computed as follows.
...
imputation model training and application.
...
Pareto frontier produced by the optimizer is the set of plans with the best imputation quality-execution time trade-offs.
