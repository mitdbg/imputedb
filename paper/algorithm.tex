...
To add an alternate imputation strategy to \ProjectName{} could be used, the analyst must provide a corresponding loss with a reasonable parameterization.
...
a canonical cost-base optimizer~\cite{blasgen1981system}.
