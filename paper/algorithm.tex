...
Given a query, \ProjectName{} produces a final set of possible plans

\begin{gather*}
 P= \{ p | \forall p'. \doms{p}{p'} \}
 \end{gather*}
...
Given $\alpha$ and $P$, \ProjectName{} returns the $\alpha$-bound optimal plan in $P$. Note that the $\alpha$-bound optimal plan is unique, given that
$P$ only maintains dominating plans.
