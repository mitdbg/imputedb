...
The computation of $\text{Time}(Q)$ is standard and is comparable to the cost model used in
...
regression trees. \todo{Micah: Probably need to look into this more carefully since I don't
know much about the learning guarantees of regression trees!} Since we conceive that
...
\todo{Micah: Notation not super clear to me. I'm guessing $|Q'|$ is the number of tuples total, but
$Q'$ is a query plan, and I would interpret it's cardinality as perhaps the height of the
tree or number of elements in the tree, not in terms of underlying relation. Similarly, I'm
not sure how to define $\text{MissingCount}(\cdot)$ above.}
