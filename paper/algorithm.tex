...
\todobox{this section must be rewritten to show new approach}{
...
\todobox{This seems tailored to decision trees, but we should talk more generally since
we claim the imputation step isn't the focus}{
...
\todobox{reorder these and explain algorithm, which right now is cutoff}{
...
\begin{algorithm}
\todo{fix input descriptions and small error in optjoin}
