...
\begin{abstract}
  ...
  We evaluate this approach on three real-world survey-based datasets and 
  ...
  Furthermore, we show that the query results from on-the-fly imputation differ from the standard full-table imputation approach by \lowsmapealphazero{}--\highsmapealphaoneexacs{}\%, in one error measure.
