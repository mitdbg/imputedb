...
\newcommand{\highxalphazeroexacs}{140} % the largest speed up, comparing a=0 to base table imputation 
\newcommand{\highxalphaoneexacs}{1400} % the largest speed up, comparing a=0 OR a=1 to base table imputation 
...
\newcommand{\highsmapealphaoneexacs}{20} % the largest SMAPE difference, comparing a=1 to base table imputation
%\newcommand{\highxalphaone}{16000}
\newcommand{\nullv}{NULL}

\newcommand{\planninglowtime}{0.7}
\newcommand{\planninglowtimepct}{0}
\newcommand{\planninghightime}{2.8}
\newcommand{\planninghightimepct}{14}

\newcommand{\planningmaxtime}{34} % TODO
...
The authors would like to acknowledge the authors of~\cite{akande2015empirical} for giving us a cleaned copy of the 2012 ACS PUMS.
