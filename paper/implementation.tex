...
\ProjectName{} on top of SimpleDB, a teaching database used at MIT, University of Washington, and Northwestern University, amongst others.

\begin{itemize}
\item \textbf{Extended histograms:}
  Ranking query plans with imputation needs estimates of the distribution of missing values in the base tables and in the outputs of sub-plans.
