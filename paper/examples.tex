...
incrementally reducing $\alpha$, as long as execution of the query completes within some
acceptable time bound.
\ProjectName{}'s planning algorithm can expose the final set of plans with optimal
