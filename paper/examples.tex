...
while her previous experiences with (2) have proven be expensive. The epidemiologist needs a more complete picture
...
\Cref{fig:quality-plan} shows a quality-optimized plan that uses the impute operation $\mu$, which employs regression model to fill in missing values rather than dropping tuples.
